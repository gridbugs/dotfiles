...
au FileType typescript.tsx,typescript,javascript,yaml,python,conf,html,css,scss set shiftwidth=2
au FileType typescript.tsx,typescript,javascript,yaml,python,conf,html,css,scss set tabstop=2
