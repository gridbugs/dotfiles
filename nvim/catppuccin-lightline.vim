...
let s:p.inactive.left =  [ [ s:c.blue, s:c.mantle ], [ s:c.overlay0, s:c.base ] ]
let s:p.inactive.middle = [ [ s:c.surface1, s:c.mantle ] ]
let s:p.inactive.right = [ [ s:c.surface1, s:c.mantle ], [ s:c.overlay0, s:c.base ] ]
